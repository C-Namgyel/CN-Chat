...
const firebaseConfig = {
    ...
    3: "https://cn-chat-7ac19-default-rtdb.firebaseio.com/"
  };
  ...
  var reply = "";
  document.getElementById("message-btn").onclick = function(ev) {
    // {
  ...
  document.getElementById("message-input").onkeydown = function(key) {
    ...
    if (key.key == "Enter" && document.getElementById("message-btn").hidden == false && key.shiftKey == false) {
      send(document.getElementById("message-input").value, reply)
      document.getElementById("message-input").value = "";
      document.getElementById("message-input").focus()
      reply = "";
